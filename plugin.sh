...
# Install the CNI plugin on all the nodes of the cluster. The plugin is detected
# and applied automatically as soon as it is installed.
install() {
  ...
  for node in "$master" "$worker1" "$worker2"; do
    ...
    # Customise plugin configuration and install to /etc/cni/net.d
